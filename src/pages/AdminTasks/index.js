...
const types = ["Task", "Meeting", "Event"];
...
const Calender = () => {
  ...
  const submitOtherEvent = () => {
    ...
    document
      .getElementById("event-Assign To")
      .classList.replace("d-none", "d-block");
    document
      .getElementById("event-Zone")
      .classList.replace("d-none", "d-block");
    document
    ...
    document
      ...
      .classList.replace("d-none", "d-block");
    document
      .getElementById("event-Attachment")
      .classList.replace("d-none", "d-block");
    document
      .getElementById("event-Piriority")
      .classList.replace("d-none", "d-block");
    document
      .getElementById("event-Level")
      .classList.replace("d-none", "d-block");
                ...
                <ModalBody>
                  ...
                  >
                    ...
                    <Row className="event-form">
                      ...
                      <Col xs={12}>
                        <div className="mb-3">
                          <Label className="form-label">Piriority</Label>
                          <Input
                            className={
                              !!isEdit
                                ? "form-control d-none"
                            ...
                            onChange={validation.handleChange}
                            onBlur={validation.handleBlur}
                            value={validation.values.Piriority || ""}
                            // invalid={
                            //   validation.touched.title &&
                            //   validation.errors.title
                            //     ? true
                            ...
                            // }
                          />
                          {validation.touched.Piriority &&
                          validation.errors.Piriority ? (
                            <FormFeedback type="invalid">
                              {validation.errors.Piriority}
                            </FormFeedback>
                          ) : null}
