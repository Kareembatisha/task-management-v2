      ...
      <Col xl={12}>
        <Card>
          <CardHeader className="align-items-center d-flex">
            <h4 className="card-title mb-0 flex-grow-1">Attendance List</h4>
                ...
                <tbody>
                  {(bestSellingProducts || []).map((item, key) => (
                    <tr key={key}>
                      ...
                      <td>
                        <h5 className="fs-14 my-1 fw-normal">morning</h5>
                        <span className="text-muted">Shift</span>
                      </td>
                      <td>
                        <h5 className="fs-14 my-1 fw-normal">9:00 AM</h5>
                        <span className="text-muted">Check In</span>
                      </td>
                      <td>
                        <h5 className="fs-14 my-1 fw-normal">5:00 PM</h5>
                        <span className="text-muted">Check Out</span>
                      </td>
                      <td>
                        <h5 className="fs-14 my-1 fw-normal">8:00 H</h5>
                        <span className="text-muted">Work Duration</span>
                      </td>
                      <td>
                        <h5 className="fs-14 my-1 fw-normal">Present</h5>
